 ...
 * href="https://developers.google.com/glass" target="_blank">API
 * Documentation</a>
 * </p>
 * 
 * <p>
 * This service uses {@link MirrorRequestInitializer} to initialize global
...
public class Mirror extends
	 ...
	 * @since 1.7
	 */
	public static final String DEFAULT_ROOT_URL = EmulatorUtil
			.getAppEngineApplicationURL();
	...
	public class Contacts {
		 ...
		 * 
		 * This request holds the parameters needed by the the mirror server.
		...
		public class Delete extends MirrorRequest<Void> {
			 ...
			 * Create a request for the method "contacts.delete".
			 * 
			 * This request holds the parameters needed by the the mirror
			 * server. After setting any optional parameters, call the
			 * {@link Delete#execute()} method to invoke the remote operation.
			 * <p>
			 * {@link Delete#initialize(com.google.api.client.googleapis.services.AbstractGoogleClientRequest)}
		...
		public class Get extends
				MirrorRequest<com.google.api.services.mirror.model.Contact> {
			...
			protected Get(java.lang.String id) {
				super(Mirror.this, "GET", REST_PATH, null,
						com.google.api.services.mirror.model.Contact.class);
				this.id = com.google.api.client.util.Preconditions
						.checkNotNull(id,
								"Required parameter id must be specified.");
			}
		 ...
		 * 
		 * @param content
		 *            the {@link com.google.api.services.mirror.model.Contact}
		 * @return the request
		 */
		public Insert insert(
				com.google.api.services.mirror.model.Contact content)
				throws java.io.IOException {
		...
		public class Insert extends
			 ...
			 * @param content
			 *            the
			 *            {@link com.google.api.services.mirror.model.Contact}
			 * @since 1.13
			 */
			protected Insert(
					com.google.api.services.mirror.model.Contact content) {
				super(Mirror.this, "POST", REST_PATH, content,
						com.google.api.services.mirror.model.Contact.class);
				checkRequiredParameter(content, "content");
				checkRequiredParameter(content.getDisplayName(),
		...
		public class List
				extends
				MirrorRequest<com.google.api.services.mirror.model.ContactsListResponse> {
		 ...
		 * @return the request
		 */
		public Patch patch(java.lang.String id,
				com.google.api.services.mirror.model.Contact content)
				throws java.io.IOException {
		...
		public class Patch extends
			 ...
			 * {@link Patch#execute()} method to invoke the remote operation.
			 * <p>
			 * {@link Patch#initialize(com.google.api.client.googleapis.services.AbstractGoogleClientRequest)}
			 * must be called to initialize this instance immediately after
			 * invoking the constructor.
			 * </p>
			 * 
			 ...
			 * @since 1.13
			 */
			protected Patch(java.lang.String id,
					com.google.api.services.mirror.model.Contact content) {
				super(Mirror.this, "PATCH", REST_PATH, content,
						com.google.api.services.mirror.model.Contact.class);
				this.id = com.google.api.client.util.Preconditions
						.checkNotNull(id,
								"Required parameter id must be specified.");
		 ...
		 * @return the request
		 */
		public Update update(java.lang.String id,
				com.google.api.services.mirror.model.Contact content)
				throws java.io.IOException {
		...
		public class Update extends
			 ...
			 * {@link Update#execute()} method to invoke the remote operation.
			 * <p>
			 * {@link Update#initialize(com.google.api.client.googleapis.services.AbstractGoogleClientRequest)}
			 * must be called to initialize this instance immediately after
			 * invoking the constructor.
			 * </p>
			 * 
			...
			protected Update(java.lang.String id,
					com.google.api.services.mirror.model.Contact content) {
				super(Mirror.this, "PUT", REST_PATH, content,
						com.google.api.services.mirror.model.Contact.class);
				this.id = com.google.api.client.util.Preconditions
						.checkNotNull(id,
								"Required parameter id must be specified.");
	...
	public class Locations {
		...
		public class Get extends
				MirrorRequest<com.google.api.services.mirror.model.Location> {
			...
			protected Get(java.lang.String id) {
				super(Mirror.this, "GET", REST_PATH, null,
						com.google.api.services.mirror.model.Location.class);
				this.id = com.google.api.client.util.Preconditions
						.checkNotNull(id,
								"Required parameter id must be specified.");
			}
		...
		public class List
				extends
				MirrorRequest<com.google.api.services.mirror.model.LocationsListResponse> {
	...
	public class Subscriptions {
		 ...
		 * @param content
		 *            the
		 *            {@link com.google.api.services.mirror.model.Subscription}
		 * @return the request
		 */
		public Insert insert(
				com.google.api.services.mirror.model.Subscription content)
				throws java.io.IOException {
			Insert result = new Insert(content);
			initialize(result);
			return result;
		...
		public class Insert
				extends
				MirrorRequest<com.google.api.services.mirror.model.Subscription> {
			...
			protected Insert(
					com.google.api.services.mirror.model.Subscription content) {
				super(Mirror.this, "POST", REST_PATH, content,
						com.google.api.services.mirror.model.Subscription.class);
				checkRequiredParameter(content, "content");
				checkRequiredParameter(content.getCallbackUrl(),
						"Subscription.getCallbackUrl()");
				checkRequiredParameter(content, "content");
				checkRequiredParameter(content.getCollection(),
		...
		public class List
				extends
				MirrorRequest<com.google.api.services.mirror.model.SubscriptionsListResponse> {
	...
	public class Timeline {
		...
		public class Get
				extends
				MirrorRequest<com.google.api.services.mirror.model.TimelineItem> {
		 ...
		 * @param content
		 *            the
		 *            {@link com.google.api.services.mirror.model.TimelineItem}
		 * @return the request
		 */
		public Insert insert(
				com.google.api.services.mirror.model.TimelineItem content)
				throws java.io.IOException {
			Insert result = new Insert(content);
			initialize(result);
			return result;
		 ...
		 * @param mediaContent
		 *            The media HTTP content or {@code null} if none.
		 * @return the request
		 * @throws java.io.IOException
		...
		public Insert insert(
				...
				throws java.io.IOException {
			Insert result = new Insert(EmulatorUtil.createTimeLineItemWithAtachement(
		...
		public class Insert
			...
			protected Insert(
					com.google.api.services.mirror.model.TimelineItem content,
					com.google.api.client.http.AbstractInputStreamContent mediaContent) {
				super(Mirror.this, "POST", "/upload/" + getServicePath()
						+ REST_PATH, content,
						com.google.api.services.mirror.model.TimelineItem.class);
		...
		public class List
				extends
				MirrorRequest<com.google.api.services.mirror.model.TimelineListResponse> {
			...
			/**
			 * If provided, only items with the given sourceItemId will be
			 * returned.
			 */
			@com.google.api.client.util.Key
		...
		public class Update
			...
			protected Update(
					...
					com.google.api.services.mirror.model.TimelineItem content,
					com.google.api.client.http.AbstractInputStreamContent mediaContent) {
				super(Mirror.this, "PUT", "/upload/" + getServicePath()
						+ REST_PATH, content,
						com.google.api.services.mirror.model.TimelineItem.class);
				this.id = com.google.api.client.util.Preconditions
						.checkNotNull(id,
		...
		public class Attachments {
			 ...
			 * @return the request
			 */
			public Delete delete(java.lang.String itemId,
					java.lang.String attachmentId) throws java.io.IOException {
			...
			public class Delete extends MirrorRequest<Void> {
				 ...
				 * This request holds the parameters needed by the the mirror
				 * server. After setting any optional parameters, call the
				 * {@link Delete#execute()} method to invoke the remote
				 * operation.
				 * <p>
				 * {@link Delete#initialize(com.google.api.client.googleapis.services.AbstractGoogleClientRequest)}
				 * must be called to initialize this instance immediately after
				 ...
				 * 
				 * @param itemId
				 *            The ID of the timeline item the attachment belongs
				 *            to.
				 * @param attachmentId
				 *            The ID of the attachment.
				 * @since 1.13
				 */
				protected Delete(java.lang.String itemId,
						java.lang.String attachmentId) {
					super(Mirror.this, "DELETE", REST_PATH, null, Void.class);
					this.itemId = com.google.api.client.util.Preconditions
							.checkNotNull(itemId,
									"Required parameter itemId must be specified.");
					this.attachmentId = com.google.api.client.util.Preconditions
			...
			/**
			 * Retrieves an attachment on a timeline item by item ID and
			 * attachment ID.
			 * 
			 ...
			 * @return the request
			 */
			public Get get(java.lang.String itemId,
					java.lang.String attachmentId) throws java.io.IOException {
			...
			public class Get
					extends
					MirrorRequest<com.google.api.services.mirror.model.Attachment> {
				...
				@Override
				public void executeMediaAndDownloadTo(
				...
				@Override
				public java.io.InputStream executeMediaAsInputStream()
						throws java.io.IOException {
			...
			public class Insert
				 ...
				 * This request holds the parameters needed by the the mirror
				 * server. After setting any optional parameters, call the
				 * {@link Insert#execute()} method to invoke the remote
				 * operation.
				 * <p>
				 * {@link Insert#initialize(com.google.api.client.googleapis.services.AbstractGoogleClientRequest)}
				 * must be called to initialize this instance immediately after
			 ...
			 * 
			 * @param itemId
			 *            The ID of the timeline item whose attachments should
			 *            be listed.
			 * @return the request
			 */
			public List list(java.lang.String itemId)
					throws java.io.IOException {
			...
			public class List
					extends
					MirrorRequest<com.google.api.services.mirror.model.AttachmentsListResponse> {
				 ...
				 * 
				 * @param itemId
				 *            The ID of the timeline item whose attachments
				 *            should be listed.
				 * @since 1.13
				 */
	...
	public static final class Builder
		...
		public Builder setMirrorRequestInitializer(
			...
			return (Builder) super
					.setGoogleClientRequestInitializer(mirrorRequestInitializer);
		}
