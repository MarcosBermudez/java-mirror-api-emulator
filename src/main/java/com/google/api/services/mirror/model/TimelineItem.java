...
public final class TimelineItem extends com.google.api.client.json.GenericJson {
    ...
    /**
     * A list of media attachments associated with this item. As a convenience, you can refer to attachments in your
     * HTML payloads with the attachment or cid scheme. For example: - attachment: where attachment_index is the 0-based
     * index of this array. - cid: where attachment_id is the ID of the attachment. The value may be {@code null}.
     */
    @com.google.api.client.util.Key
    private java.util.List<Attachment> attachments;

    /**
     * The bundle ID for this item. Services can specify a bundleId to group many items together. They appear under a
     * single top-level item on the device. The value may be {@code null}.
     */
    @com.google.api.client.util.Key
    private java.lang.String bundleId;

    /**
     * A canonical URL pointing to the canonical/high quality version of the data represented by the timeline item. The
    ...
    /**
     * The time at which this item was created, formatted according to RFC 3339. The value may be {@code null}.
     */
    @com.google.api.client.util.Key
    private java.lang.String created;

    /**
     * The user or group that created this item. The value may be {@code null}.
     */
    @com.google.api.client.util.Key
    private Contact creator;

    /**
     * The time that should be displayed when this item is viewed in the timeline, formatted according to RFC 3339. This
     * user's timeline is sorted chronologically on display time, so this will also determine where the item is
     * displayed in the timeline. If not set by the service, the display time defaults to the updated time. The value
     * may be {@code null}.
     */
    @com.google.api.client.util.Key
    ...
    /**
     * ETag for this item. The value may be {@code null}.
     */
    @com.google.api.client.util.Key
    private java.lang.String etag;

    /**
     * HTML content for this item. If both text and html are provided for an item, the html will be rendered in the
     * timeline. Allowed HTML elements - You can use these elements in your timeline cards. - Headers: h1, h2, h3, h4,
     * h5, h6 - Images: img - Lists: li, ol, ul - HTML5 semantics: article, aside, details, figure, figcaption, footer,
     * header, nav, section, summary, time - Structural: blockquote, br, div, hr, p, span - Style: b, big, center, em,
     * i, u, s, small, strike, strong, style, sub, sup - Tables: table, tbody, td, tfoot, th, thead, tr Blocked HTML
     * elements: These elements and their contents are removed from HTML payloads. - Document headers: head, title -
     * Embeds: audio, embed, object, source, video - Frames: frame, frameset - Scripting: applet, script Other elements:
     * Any elements that aren't listed are removed, but their contents are preserved. The value may be {@code null}.
     */
    @com.google.api.client.util.Key
    private java.lang.String html;

    /**
     * This field is deprecated, use the html property with pagination instead. The value may be {@code null}.
     */
    @com.google.api.client.util.Key
    private java.util.List<java.lang.String> htmlPages;

    /**
     * The ID of the timeline item. This is unique within a user's timeline. The value may be {@code null}.
     */
    @com.google.api.client.util.Key
    private java.lang.String id;

    /**
     * If this item was generated as a reply to another item, this field will be set to the ID of the item being replied
     * to. This can be used to attach a reply to the appropriate conversation or post. The value may be {@code null}.
     */
    @com.google.api.client.util.Key
     ...
     * 
     * On the main timeline, items that are shown are: - Items that have isBundleCover set to true - Items that do not
     * have a bundleId In a bundle sub-timeline, items that are shown are: - Items that have the bundleId in question
     * AND isBundleCover set to false The value may be {@code null}.
     */
    @com.google.api.client.util.Key
    private java.lang.Boolean isBundleCover;

    /**
     * When true, indicates this item is deleted, and only the ID property is set. The value may be {@code null}.
     */
    @com.google.api.client.util.Key
    private java.lang.Boolean isDeleted;

    /**
     * When true, indicates this item is pinned, which means it's grouped alongside "active" items like navigation and
     * hangouts, on the opposite side of the home screen from historical (non- pinned) timeline items. You can allow the
     * user to toggle the value of this property with the TOGGLE_PINNED built-in menu item. The value may be
     * {@code null}.
     */
    @com.google.api.client.util.Key
    ...
    /**
     * The type of resource. This is always mirror#timelineItem. The value may be {@code null}.
     */
    @com.google.api.client.util.Key
    private java.lang.String kind;

    /**
     * The geographic location associated with this item. The value may be {@code null}.
     */
    @com.google.api.client.util.Key
    private Location location;

    /**
     * A list of menu items that will be presented to the user when this item is selected in the timeline. The value may
     * be {@code null}.
     */
    @com.google.api.client.util.Key
    ...
    /**
     * Controls how notifications for this item are presented on the device. If this is missing, no notification will be
     * generated. The value may be {@code null}.
     */
    @com.google.api.client.util.Key
    private NotificationConfig notification;

    /**
     * For pinned items, this determines the order in which the item is displayed in the timeline, with a higher score
     * appearing closer to the clock. Note: setting this field is currently not supported. The value may be {@code null}
     * .
     */
    @com.google.api.client.util.Key
    ...
    /**
     * A list of users or groups that this item has been shared with. The value may be {@code null}.
     */
    @com.google.api.client.util.Key
    private java.util.List<Contact> recipients;

    /**
     * A URL that can be used to retrieve this item. The value may be {@code null}.
     */
    @com.google.api.client.util.Key
    private java.lang.String selfLink;

    /**
     * Opaque string you can use to map a timeline item to data in your own service. The value may be {@code null}.
     */
    @com.google.api.client.util.Key
    private java.lang.String sourceItemId;

    /**
     * The speakable version of the content of this item. Along with the READ_ALOUD menu item, use this field to provide
     * text that would be clearer when read aloud, or to provide extended information to what is displayed visually on
     * Glass.
     * 
     * Glassware should also specify the speakableType field, which will be spoken before this text in cases where the
     * additional context is useful, for example when the user requests that the item be read aloud following a
     * notification. The value may be {@code null}.
     */
    @com.google.api.client.util.Key
    private java.lang.String speakableText;

    /**
     * A speakable description of the type of this item. This will be announced to the user prior to reading the content
     * of the item in cases where the additional context is useful, for example when the user requests that the item be
     * read aloud following a notification.
     * 
     ...
     * speakableText or text so that the user can learn the type of the item without looking at the screen. The value
     * may be {@code null}.
     */
    @com.google.api.client.util.Key
    ...
    /**
     * Text content of this item. The value may be {@code null}.
     */
    @com.google.api.client.util.Key
    private java.lang.String text;

    /**
     * The title of this item. The value may be {@code null}.
     */
    @com.google.api.client.util.Key
    private java.lang.String title;

    /**
     * The time at which this item was last modified, formatted according to RFC 3339. The value may be {@code null}.
     */
    @com.google.api.client.util.Key
     ...
     * A list of media attachments associated with this item. As a convenience, you can refer to attachments in your
     * HTML payloads with the attachment or cid scheme. For example: - attachment: where attachment_index is the 0-based
     * index of this array. - cid: where attachment_id is the ID of the attachment.
     * 
    ...
    /**
     * The bundle ID for this item. Services can specify a bundleId to group many items together. They appear under a
     * single top-level item on the device.
     * 
     * @return value or {@code null} for none
     */
     ...
     * The time that should be displayed when this item is viewed in the timeline, formatted according to RFC 3339. This
     * user's timeline is sorted chronologically on display time, so this will also determine where the item is
     * displayed in the timeline. If not set by the service, the display time defaults to the updated time.
     * 
     * @return value or {@code null} for none
     */
     ...
     * elements: These elements and their contents are removed from HTML payloads. - Document headers: head, title -
     * Embeds: audio, embed, object, source, video - Frames: frame, frameset - Scripting: applet, script Other elements:
     * Any elements that aren't listed are removed, but their contents are preserved.
     * 
     * @return value or {@code null} for none
     */
    ...
    /**
     * If this item was generated as a reply to another item, this field will be set to the ID of the item being replied
     * to. This can be used to attach a reply to the appropriate conversation or post.
     * 
     * @return value or {@code null} for none
     */
     ...
     * On the main timeline, items that are shown are: - Items that have isBundleCover set to true - Items that do not
     * have a bundleId In a bundle sub-timeline, items that are shown are: - Items that have the bundleId in question
     * AND isBundleCover set to false
     * 
     * @return value or {@code null} for none
     */
     ...
     * When true, indicates this item is pinned, which means it's grouped alongside "active" items like navigation and
     * hangouts, on the opposite side of the home screen from historical (non- pinned) timeline items. You can allow the
     * user to toggle the value of this property with the TOGGLE_PINNED built-in menu item.
     * 
     * @return value or {@code null} for none
     */
