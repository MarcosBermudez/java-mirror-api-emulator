...
public final class Notification extends com.google.api.client.json.GenericJson {
    ...
    /**
     * The collection that generated the notification. The value may be {@code null}.
     */
    ...
    /**
     * A list of actions taken by the user that triggered the notification. The value may be {@code null}.
     */
    @com.google.api.client.util.Key
    private java.util.List<UserAction> userActions;

    static {
        // hack to force ProGuard to consider UserAction used, since otherwise it would be stripped out
        // see http://code.google.com/p/google-api-java-client/issues/detail?id=528
        com.google.api.client.util.Data.nullOf(UserAction.class);
    }

    /**
     * The user token provided by the service when it subscribed for notifications. The value may be {@code null}.
     */
    @com.google.api.client.util.Key
    private java.lang.String userToken;

    /**
     * The secret verify token provided by the service when it subscribed for notifications. The value may be
     * {@code null}.
     */
    @com.google.api.client.util.Key
