...
public final class Contact extends com.google.api.client.json.GenericJson {
    ...
    /**
     * A list of voice menu commands that a contact can handle. The value may be {@code null}.
     */
    @com.google.api.client.util.Key
    private java.util.List<Command> acceptCommands;

    /**
     * A list of MIME types that a contact supports. The contact will be shown to the user if any of its acceptTypes
     * matches any of the types of the attachments on the item. If no acceptTypes are given, the contact will be shown
     * for all items. The value may be {@code null}.
     */
    @com.google.api.client.util.Key
    private java.util.List<java.lang.String> acceptTypes;

    /**
     * The name to display for this contact. The value may be {@code null}.
     */
    @com.google.api.client.util.Key
    private java.lang.String displayName;

    /**
     * An ID for this contact. This is generated by the application and is treated as an opaque token. The value may be
     * {@code null}.
     */
    @com.google.api.client.util.Key
    ...
    /**
     * Set of image URLs to display for a contact. Most contacts will have a single image, but a "group" contact may
     * include up to 8 image URLs and they will be resized and cropped into a mosaic on the client. The value may be
     * {@code null}.
     */
    @com.google.api.client.util.Key
    ...
    /**
     * The type of resource. This is always mirror#contact. The value may be {@code null}.
     */
    @com.google.api.client.util.Key
    private java.lang.String kind;

    /**
     * Primary phone number for the contact. This can be a fully-qualified number, with country calling code and area
     * code, or a local number. The value may be {@code null}.
     */
    @com.google.api.client.util.Key
    private java.lang.String phoneNumber;

    /**
     * Priority for the contact to determine ordering in a list of contacts. Contacts with higher priorities will be
     * shown before ones with lower priorities. The value may be {@code null}.
     */
    @com.google.api.client.util.Key
    private java.lang.Long priority;

    /**
     * The ID of the application that created this contact. This is populated by the API The value may be {@code null}.
     */
    @com.google.api.client.util.Key
    private java.lang.String source;

    /**
     * Name of this contact as it should be pronounced. If this contact's name must be spoken as part of a voice
     * disambiguation menu, this name is used as the expected pronunciation. This is useful for contact names with
     * unpronounceable characters or whose display spelling is otherwise not phonetic. The value may be {@code null}.
     */
    @com.google.api.client.util.Key
    private java.lang.String speakableName;

    /**
     * The type for this contact. This is used for sorting in UIs. Allowed values are: - INDIVIDUAL - Represents a
     * single person. This is the default. - GROUP - Represents more than a single person. The value may be {@code null}
     * .
     */
    @com.google.api.client.util.Key
    ...
    /**
     * Set of image URLs to display for a contact. Most contacts will have a single image, but a "group" contact may
     * include up to 8 image URLs and they will be resized and cropped into a mosaic on the client.
     * 
     * @return value or {@code null} for none
     */
    ...
    /**
     * Priority for the contact to determine ordering in a list of contacts. Contacts with higher priorities will be
     * shown before ones with lower priorities.
     * 
     * @return value or {@code null} for none
     */
     ...
     * Name of this contact as it should be pronounced. If this contact's name must be spoken as part of a voice
     * disambiguation menu, this name is used as the expected pronunciation. This is useful for contact names with
     * unpronounceable characters or whose display spelling is otherwise not phonetic.
     * 
     * @return value or {@code null} for none
     */
    ...
    /**
     * The type for this contact. This is used for sorting in UIs. Allowed values are: - INDIVIDUAL - Represents a
     * single person. This is the default. - GROUP - Represents more than a single person.
     * 
     * @return value or {@code null} for none
     */
