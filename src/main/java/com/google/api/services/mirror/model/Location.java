...
public final class Location extends com.google.api.client.json.GenericJson {
    ...
    /**
     * The accuracy of the location fix in meters. The value may be {@code null}.
     */
    @com.google.api.client.util.Key
    private java.lang.Double accuracy;

    /**
     * The full address of the location. The value may be {@code null}.
     */
    @com.google.api.client.util.Key
    private java.lang.String address;

    /**
     * The name to be displayed. This may be a business name or a user-defined place, such as "Home". The value may be
     * {@code null}.
     */
    @com.google.api.client.util.Key
    ...
    /**
     * The ID of the location. The value may be {@code null}.
     */
    @com.google.api.client.util.Key
    private java.lang.String id;

    /**
     * The type of resource. This is always mirror#location. The value may be {@code null}.
     */
    @com.google.api.client.util.Key
    private java.lang.String kind;

    /**
     * The latitude, in degrees. The value may be {@code null}.
     */
    @com.google.api.client.util.Key
    private java.lang.Double latitude;

    /**
     * The longitude, in degrees. The value may be {@code null}.
     */
    @com.google.api.client.util.Key
